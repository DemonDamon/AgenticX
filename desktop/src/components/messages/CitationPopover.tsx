...
export function CitationPopover({ reference }: Props) {
  ...
  return (
    <div
      className="w-[min(320px,calc(100vw-2rem))] rounded-xl border border-border-subtle bg-surface-base p-3 text-left shadow-[0_8px_28px_rgba(0,0,0,0.35)]"
    ...
    >
      ...
      >
        <span
          ...
          style={{
            backgroundColor: isKb ? "var(--kb-citation-bg)" : "var(--surface-card-strong)",
            color: isKb ? "var(--kb-citation-fg)" : "var(--text-subtle)",
          }}
        >
        ...
        <span
          ...
          style={{ color: isKb ? "var(--kb-citation-fg)" : "rgba(var(--theme-color-rgb,6,182,212),0.95)" }}
