            ...
            <div
              className={
                compactAssistant && noBubbleBorder
                  ? "relative min-w-0 w-full overflow-x-auto overflow-y-visible px-3 py-2.5 text-[16px] leading-relaxed"
                  : `relative min-w-0 overflow-x-auto overflow-y-visible rounded-xl border px-3 py-2 text-[16px] leading-relaxed ${isUser ? "max-w-full rounded-tr-[4px]" : "w-full rounded-tl-[4px]"}`
              }
