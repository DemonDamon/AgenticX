        ...
        <div className="agx-pane-composer-shell shrink-0 px-4 py-2.5">
          ...
          <div className="agx-pane-composer-body relative rounded-2xl border border-border bg-surface-card transition-all duration-300 ease-out focus-within:border-pink-500/40 focus-within:shadow-[0_0_24px_rgba(236,72,153,0.15)] dark:focus-within:shadow-[0_0_24px_rgba(244,114,182,0.2)]">
            ...
            <div
              ...
              className={`agx-pane-composer-input block w-full overflow-y-auto whitespace-pre-wrap break-words bg-transparent px-4 pb-0 pt-4 text-[14px] leading-relaxed text-text-primary outline-none ${
            ...
            />
            {input.trim().length === 0 ? (
              <div className="agx-pane-composer-placeholder pointer-events-none absolute left-4 top-4 text-[14px] text-text-faint">
                {focusMode ? "开始任务..." : "发消息..."}
              </div>
            ) : null}
