...
declare global {
  interface Window {
    agenticxDesktop: {
      ...
      loadGatewayAdapters: () => Promise<import("../electron/gateway-adapter-config").GatewayAdapterForm>;
      saveGatewayAdapters: (
        payload: import("../electron/gateway-adapter-config").GatewayAdapterForm,
      ) => Promise<{ ok: boolean }>;
