...
> 前序：`2026-08-10-enterprise-trace-runtime-tree`（聚合 API + 过程树）、`2026-08-10-trace-runtime-litefuse-style-ui`（双栏 + 本轮对话 I/O）。
...
- 不引入 OTLP exporter、不引入 litefuse/langfuse 依赖
