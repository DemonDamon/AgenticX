...
**迁移：** 按现有序号续写
- `enterprise/packages/db-schema/drizzle/0043_deep_research_runs_trace_id.sql`
- `enterprise/packages/db-schema/drizzle-mysql/0017_deep_research_runs_trace_id.sql`
