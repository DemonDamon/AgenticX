...
| S6 | `gateway-slo-via-query` | **已拆** [subplan](../2026-09-07-gateway-slo-via-query.plan.md)。调查 Agent 按通道/模型查 TTFT、TPS、冷却、plugin 错误；人看页复用默认观测盒服务视图，不另做看板必选项 | Composer 2.5 | S2 |
...
3. **S1 / S2 / S2.1 / S3 已拆出可实施 subplan：**
   ...
   - S6：`.cursor/plans/2026-09-07-gateway-slo-via-query.plan.md`
   S7–S18 先不拆。开干前把对应文件移到 `.cursor/plans/` 根目录。
