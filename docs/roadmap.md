...
| **M4** | Memory System — Workspace and short-term memory, MCP memory, session scratchpads |
...
| **M11** | Safety Layer — Injection detection, policy engine, audit logging, workspace command isolation |
