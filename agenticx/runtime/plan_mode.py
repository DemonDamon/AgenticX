...
_PLAN_MODE_BLOCK = (
    ...
    "Use plan_update only for non-execution lifecycle changes to an existing project-local Plan artifact.\n"
    "Never start implementation or advance Todo execution status in Plan mode; Build handles that transition.\n"
