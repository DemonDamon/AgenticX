...
export { getChatCopy, chatCopyKeys } from "./i18n/chat-copy";
export type { ChatCopy, PortalLocale } from "./i18n/chat-copy";
export { ChatLocaleProvider, useChatCopy, useChatLocale } from "./i18n/ChatLocaleProvider";
